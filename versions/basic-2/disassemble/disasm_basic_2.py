...
d.comment(0x8693, 'OPT bit 0 (errors enabled)?', align=Align.INLINE)
...
d.comment(0x99ce, 'IWA = the integer dividend', align=Align.INLINE)
...
d.comment(0xac15, 'store the quote flag (&3B)', align=Align.INLINE)
...
d.comment(0x89e7, 'clear quote', align=Align.INLINE)
...
d.comment(0x8a51, '(clear carry)', align=Align.INLINE)
