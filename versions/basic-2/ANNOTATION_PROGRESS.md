...
**STATUS: in progress — 1,197 of 7,129 placeholders left (16.8 %);
...
`fp_split_int_frac` (13), then `fp_eval_cont_frac` (13), `stmt_call`
(9), `fwa_to_int` (4), and the rest of depths 2–8. Per routine:
