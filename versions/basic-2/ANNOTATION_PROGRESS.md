...
**STATUS: in progress — 600 of 7,129 placeholders left (8.4 %);
...
`fn_mids` (12), then `fn_ln` (10), `stmt_sound` (10),
`stmt_envelope` (9), and the rest of depths 5–8.
(`stmt_dim`, `parse_var_ref`, `unstack_value_to_var`, `iwa_divide`,
`check_end_of_statement`, `iwa_test_var`, `stmt_print`,
`asm_opcode_add4`, `iwa_add`, `fn_eval`, `iwa_rsub`, `fn_instr` done
