...
**STATUS: in progress — 559 of 7,129 placeholders left (7.8 %);
...
`execute_line` (8), then `stmt_plot` (7), and the rest of depths 5–8.
...
`fn_mids`, `fn_ln`, `stmt_sound`, `stmt_envelope`.) Per routine:
