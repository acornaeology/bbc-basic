...
**STATUS: in progress — 1,125 of 7,129 placeholders left (15.8 %);
...
`ascii_to_number` (10), `print_token` (10), `fwa_complement_half_pi`
(9), `read_input_line` (9), then the rest of depths 3–8. Per routine:
